...
class PlayerController {
  ...
  async playOrPause() {
    ...
    if (!audioManager.paused) await this.pause();
  ...
  public async togglePlayMode(mode: string | false) {
    switch (mode) {
      case "off":
        this.playModeManager.toggleRepeat("off");
        await this.playModeManager.toggleShuffle("off");
        break;
      case "repeat":
        await this.playModeManager.toggleShuffle("off");
        this.playModeManager.toggleRepeat("list");
        break;
      case "repeat-once":
        await this.playModeManager.toggleShuffle("off");
        this.playModeManager.toggleRepeat("one");
        break;
      case "shuffle":
        this.playModeManager.toggleRepeat("off");
        await this.playModeManager.toggleShuffle("on");
        break;
      case "heartbeat":
        this.playModeManager.toggleRepeat("off");
        await this.playModeManager.toggleShuffle("heartbeat");
        break;
      default:
        break;
    }
