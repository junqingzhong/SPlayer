      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: "文字大小",
            type: "input-number",
            description: "设置任务栏歌词的基准文字大小，默认为 14px",
            min: 10,
            max: 30,
            step: 1,
            suffix: "px",
            value: toRef(settingStore, "taskbarLyricFontSize"),
            show: () => settingStore.taskbarLyricMode === "taskbar",
          },
          {
            ...
            label: "主歌词缩放",
            type: "input-number",
            description: "设置主歌词的缩放比例，默认为 1.0",
            min: 0.5,
            max: 1.5,
            step: 0.05,
            value: toRef(settingStore, "taskbarLyricMainScale"),
          },
          {
            key: "taskbarLyricSubScale",
            label: "副歌词缩放",
            type: "input-number",
            description: "设置副歌词（翻译/下一句）的缩放比例，默认为 0.8",
            min: 0.5,
            max: 1.0,
            step: 0.05,
            value: toRef(settingStore, "taskbarLyricSubScale"),
          },
        ],
      },
      {
