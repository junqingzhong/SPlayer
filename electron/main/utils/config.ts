 ...
 * @LastEditTime: 2025-12-11 18:34:15
 * @FilePath: \tea\electron\main\utils\config.ts
 * @Description:
 *
 ...
 * @returns string
 */
export const appName = app.getName() || "silenceMusic";

/**
 * 服务器端口
 * @returns number
 */
export const port = Number(process.env["VITE_SERVER_PORT"] || 25884);
